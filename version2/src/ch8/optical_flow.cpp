...
class OpticalFlowTracker {
 public:
  OpticalFlowTracker(const cv::Mat &img1_, const cv::Mat &img2_,
...
int main(int argc, char **argv) {
  ...
  vector<cv::KeyPoint> kp2_single;//-----------------------------------------single-level
  vector<bool> success_single;
  OpticalFlowSingleLevel(img1, img2, kp1, kp2_single, success_single);

  // then test multi-level LK------------------------------------------------multi-level
  ...
  // use opencv's flow for validation------------------------------------------opencv
  ...
  // plot the differences of those functions-------------------------------------plot and save
  cv::Mat img2_single;
  cv::cvtColor(img2, img2_single, CV_GRAY2BGR);  // CV_GRAY2BGR); COLOR_BGR2GRAY
...
void OpticalFlowSingleLevel(const cv::Mat &img1, const cv::Mat &img2,
                            ...
                            bool has_initial) {  // has_initial default=false
  kp2.resize(kp1.size());
...
void OpticalFlowTracker::calculateOpticalFlow(const cv::Range &range) {
  ...
  for (size_t i = range.start; i < range.end; i++) {
    ...
    if (has_initial) {      // has_initial default=false
